...
public class Matrix33 {
	...
	public static Matrix33 getXRotationMatrix(float theta) {
	...
	public static Matrix33 getYRotationMatrix(float theta) {
	...
	public static Matrix33 getZRotationMatrix(float theta) {
